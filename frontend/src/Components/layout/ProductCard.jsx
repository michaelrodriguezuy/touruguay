...
const ProductCard = ({ product }) => {
    return (
        <div className="w-full mx-auto bg-white shadow-lg rounded-lg overflow-hidden relative">
            <img className="w-full h-48 object-cover" src={product.urlImagen[0]} alt={product.product_name} />
            <div className="p-4">
                <h2 className="text-xl font-semibold text-[#e66a54]">{product.product_name}</h2>
