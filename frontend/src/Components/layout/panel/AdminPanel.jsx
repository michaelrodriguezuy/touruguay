    ...
    return (
        <>
            <div className='flex justify-end gap-4 p-4'>
                <button className='bg-[#e66a54] hover:bg-[#017999] text-white font-bold py-2 px-4 rounded-full'>Agregar</button>
                <button className='bg-[#e66a54] hover:bg-[#017999] text-white font-bold py-2 px-4 rounded-full'>Eliminar</button>
                <button className='bg-[#e66a54] hover:bg-[#017999] text-white font-bold py-2 px-4 rounded-full'>Editar</button>
            </div>
